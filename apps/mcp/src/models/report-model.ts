...
export type ReportType = Partial<
  mongoose.InferSchemaType<typeof reportSchema>
> &
  Partial<{
    user_id: string;
    category: string;
...
export const reportModel =
  (mongoose.models.reportSchema as mongoose.Model<ReportSchemaType>) ||
  mongoose.model<ReportSchemaType>("report_model", reportSchema);
