...
router.route("/:id/status").patch(AuthMiddlware, asyncHandler(reportController.updateReportStatus.bind(reportController)))
router.route("/:id").delete(AuthMiddlware, asyncHandler(reportController.deleteReportById.bind(reportController)))
